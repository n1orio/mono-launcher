<template>
  <div class="flex h-9 shrink-0 items-center gap-2 border-b border-[var(--border)] bg-[var(--panel)] px-3">
    ...
    <template v-else>
      <button type="button" class="group flex h-3 w-3 items-center justify-center rounded-full bg-[#f85149] transition-colors hover:bg-[#f85149]/80" :title="t('common.close')" @click="close">
      ...
      <button type="button" class="group flex h-3 w-3 items-center justify-center rounded-full bg-[#e3b341] transition-colors hover:bg-[#e3b341]/80" @click="minimize">
      ...
      <button type="button" class="group flex h-3 w-3 items-center justify-center rounded-full bg-[#3fb950] transition-colors hover:bg-[#3fb950]/80" @click="toggleMaximize">
